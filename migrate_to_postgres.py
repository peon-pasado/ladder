...
def migrate_to_postgres():
    ...
    try:
        ...
        if len(parts) != 2:
            print("Error: URL de conexión mal formateada")
            sys.exit(1)
    ...
    try:
        ...
        try:
            ...
            # Comprobar si se puede crear tablas
            pg_cursor.execute("CREATE TABLE IF NOT EXISTS test_connection (id SERIAL PRIMARY KEY, test VARCHAR(10))")
            pg_conn.commit()
