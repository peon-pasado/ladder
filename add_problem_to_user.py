...
try:
    ...
    # 0. Mostrar todos los usuarios disponibles
    ...
    username = user[0]
    print(f"✅ Usuario seleccionado: {username} (ID: {user_id})")
    ...
    # 2. Desmarcar cualquier problema actual en el ladder del usuario
    cursor.execute("""
    ...
    # 3. Verificar si el problema ya existe en el ladder
    cursor.execute("""
    ...
    # 4. Verificar el estado del ladder
    cursor.execute("""
