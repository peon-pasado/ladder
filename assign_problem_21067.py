...
problem_id = "21067"  # El problema correcto
baekjoon_username = "fischer"
position = 1

print(f"Asignando el problema {problem_id} como el único problema actual en el ladder de {baekjoon_username}...")
...
try:
    ...
    print("\n✨ ¡Ladder reiniciado correctamente! Ahora solo tiene el problema 21067 como actual.")
